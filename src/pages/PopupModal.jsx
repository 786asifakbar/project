        ...
        >
          <div className="bg-blue-100 text-black rounded-lg w-full max-w-xs sm:max-w-lg p-4 sm:p-6 shadow-lg">
            <div className="flex justify-between items-center">
              <h2 className="text-xl sm:text-2xl font-extrabold text-blue-600">Thank You for Your Support!</h2>
              <button
                onClick={closeModal}
                className="text-red-500 text-3xl sm:text-4xl font-bold hover:text-red-700 transition duration-300"
              >
                &times;
              </button>
            </div>
            ...
            <div className="mt-4 sm:mt-6">
              <ul className="list-disc pl-6 space-y-2">
                <li className="text-base sm:text-lg text-blue-800">
            ...
            <div className="mt-4 sm:mt-6 flex justify-center gap-4 flex-wrap">
              <button
                ...
                className="px-4 sm:px-6 py-2 mb-4 sm:mb-0 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300"
              >
                JazzCash
              </button>
              ...
              <button
                ...
                className="px-4 sm:px-6 py-2 mb-4 sm:mb-0 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-300"
              >
                Easypaisa
              </button>
              ...
              <button
                ...
                className="px-4 sm:px-6 py-2 mb-4 sm:mb-0 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition duration-300"
              >
                Bank Transfer
              </button>
            </div>
